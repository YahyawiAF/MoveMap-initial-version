/*
  ...
  - You are about to drop the column `areaName` on the `County` table. All the data in the column will be lost.
  - You are about to drop the column `price2020Q4` on the `County` table. All the data in the column will be lost.
  - Added the required column `homePrice2020Q4` to the `County` table without a default value. This is not possible if the table is not empty.
  - Added the required column `isMetroArea` to the `County` table without a default value. This is not possible if the table is not empty.
